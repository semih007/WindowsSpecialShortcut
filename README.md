...
- Servis + exe eşleştirmeleri ekleme/silme (config.json) - Birden fazla exe ile birden fazla servis desteklenir.
- Senkronize Başlatma: servisler Running olana kadar 5sn boyunca bekleme, sonra exe'ler başlatma
...
4. Servis adlarını virgülle ayrılmış girin (ör: pangpg, başkaServis), exe yollarını virgülle ayrılmış girip "Eşleştirme Ekle".
